    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flight', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='base.flight')),
                ('passengers', models.ManyToManyField(related_name='flight_tickets', to='base.passenger')),
        ...
        migrations.AddField(
            model_name='flight',
            name='depart_day',
            field=models.ManyToManyField(related_name='flights_of_the_day', to='base.week'),
        ),
        migrations.AddField(
            model_name='flight',
            name='destination',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='arrivals', to='base.place'),
        ),
        migrations.AddField(
            model_name='flight',
            name='origin',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departures', to='base.place'),
        ),
    ]
